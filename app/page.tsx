  ...
  return (
      <div className="min-h-screen flex flex-col">
          ...
          <div className="container px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
            ...
            <div className="relative space-y-8 max-w-4xl">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-50 text-blue-700 text-sm font-medium mb-2">
                ...
                <span>Transforming EHR Interactions for Healthcare Professionals</span>
              </div>
              ...
              <p className="max-w-[800px] mx-auto text-lg text-gray-600 md:text-xl/relaxed lg:text-2xl/relaxed">
                ...
                <span className="font-semibold text-blue-600"> ask</span> for the patient information you need.
              </p>
            ...
            <div className="relative w-full max-w-4xl mt-16 rounded-xl shadow-2xl shadow-blue-100 border border-blue-100 overflow-hidden">
              ...
              <div className="bg-white p-4 rounded-t-xl border-b border-blue-100 flex items-center">
                ...
                <div className="text-sm text-gray-500 font-medium">MediQuery EHR Assistant</div>
              </div>
              <div className="relative z-10 bg-white p-6">
                <div className="flex">
                  <div className="w-1/3 border-r border-blue-100 pr-4">
                    <div className="text-sm font-medium text-blue-800 mb-3">Patient List</div>
                    {[1, 2, 3, 4, 5].map((i) => (
                        <div
                            key={i}
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500">ID: {100000 + i}</div>
                          </div>
                        </div>
                    ))}
                  </div>
                  <div className="w-2/3 pl-6">
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Female, 42 years • ID: 100002</div>
                      </div>
                    </div>
                    <div className="bg-blue-50 rounded-lg p-4 mb-4">
                      <div className="text-sm text-blue-800 mb-2">Query</div>
                      <div className="font-medium">What are Sarah's latest lab results and medication history?</div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-start mb-3">
                        ...
                        <div>
                          <div className="text-sm font-medium text-blue-800 mb-1">MediQuery AI</div>
                          <div className="text-sm">
                            <p className="mb-2">
                              <span className="font-medium">Latest Lab Results (March 15, 2025):</span>
                            </p>
                            <ul className="list-disc pl-5 mb-3 space-y-1">
                              <li>Hemoglobin A1c: 5.7% (Normal range: &lt;5.7%)</li>
                              <li>Cholesterol: 185 mg/dL (Normal range: &lt;200 mg/dL)</li>
          ...
          <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-lg text-blue-700">
                Our AI assistant helps healthcare professionals access patient information quickly and efficiently.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              {[
                ...
                },
                {
                  ...
                  description: "Reduce documentation time by up to 40%, allowing more meaningful patient interactions.",
                },
                {
                  icon: <FileText className="h-6 w-6" />,
                  title: "Comprehensive EHR Integration",
                  description: "Seamlessly connects with major EHR systems including Epic, Cerner, and Allscripts.",
                },
                {
        ...
        <section className="py-20">
          <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-blue-900">How MediQuery Works</h2>
              <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
                Designed for healthcare professionals with security and efficiency in mind.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  description: "Choose a patient from your roster or search by name, ID, or other identifiers.",
                },
                {
                  step: "03",
                  title: "Ask Naturally",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  <div key={index} className="bg-white p-8 rounded-xl shadow-sm border border-blue-100">
          ...
          <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Join healthcare professionals who are saving hours each week and improving patient care with MediQuery.
              </p>
          ...
          <div className="container px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-6 md:mb-0">
                ...
                <p className="text-sm text-blue-200 mt-2">Transforming EHR interactions for healthcare professionals</p>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-blue-800 text-center text-sm text-blue-300">
              © {new Date().getFullYear()} MediQuery Health Technologies. All rights reserved.
            </div>
          </div>
        </footer>
      </div>
